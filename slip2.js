(function(WIN, DOC) {
    ...
    Slip = (function() {
        ...
        Slip.prototype.setAni = function(_duration) {
            setTransition(this.ele, "all " + _duration + "ms ease-in");
            return this;
        };
        ...
        Slip.prototype.slider = function(elPages) {
            ...
            pageNum = this.pageNum = elPagesLen ? elPagesLen : 3;
